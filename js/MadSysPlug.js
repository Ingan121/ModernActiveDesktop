...
(function() {
    ...
    let spotifyAbortController = new AbortController();
    ...
    async function request(endpoint, data, headers = {}, rawReturn, signal) {
        ...
        if (data) {
            ...
            return await fetch(`http://localhost:3031/${endpoint}`, {
                method: "POST", headers, body: data, signal
    ...
    // Return: "OK" if successful, -1 if abrupt or failed
    ...
    async function spotifyLogin() {
        ...
        spotifyAbortController.abort();
        spotifyAbortController = new AbortController();
        const response = await request("spotify/auth", null, {}, true, spotifyAbortController.signal);
