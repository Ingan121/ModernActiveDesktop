...
(function () {
    ...
    const fallbackStrings = {
        ...
        "WELCOME_SETUP_SYSPLUG_CONTENT": "For better usability, installing the system plugin is highly recommended.<br><br>It allows better integration between your system and the wallpaper, such as opening a new browser window from the wallpaper, receiving your keyboard input directly, or controlling the currently playing media.<br><br>Click for more information, including the setup instructions.",
